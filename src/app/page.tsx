...
// https://api.openweathermap.org/data/2.5/forecast?q=pune&appid=c645f6e8fa5a229bcdddbf9070dc3e66
...
export default function Home() {
  ...
  const { isLoading, error, data , refetch} = useQuery<WeatherData>({
    queryKey: ["repoData"], // Use 'queryKey' to define the unique key for the query
    queryFn: async () => {
